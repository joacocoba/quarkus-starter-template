...
public class TransactionResource {
    ...
    @POST
    @Operation(summary = "Create a new transaction", description = "Creates a new pending transaction")
    @APIResponses({
    ...
    public Response listTransactions(
        ...
        TransactionListResponse response = TransactionListResponse.of(responses, totalCount, offset, limit);
        return Response.ok(response).build();
    }
}
